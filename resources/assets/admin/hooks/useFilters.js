...
export function useFilters(initialFilters = { selectedValues: [], selectedOptions: [] }, setFilters, setPage ) {
    ...
    const removeFilter = (value) => {
        setSelectedStatuses(prevState => {
            ...
            const newSelectedOptions = prevState.selectedOptions.filter(option => option.value !== value);
