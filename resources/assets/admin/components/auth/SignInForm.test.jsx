...
describe("SignInForm Component", () => {
    ...
    test('Validation for login and password', async () => {
        ...
        expect(await screen.findByText(/Login must be at least 3 characters/i))
            .toBeInTheDocument();
        expect(await screen.findByText(/Password must be at least 3 characters/i))
            .toBeInTheDocument();
        ...
        expect(await screen.findByText(/Login must be at most 255 characters/i))
            .toBeInTheDocument();
        expect(await screen.findByText(/Password must be at most 255 characters/i))
            .toBeInTheDocument();
    });
