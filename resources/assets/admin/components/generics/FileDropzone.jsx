...
const getDropzoneStyles = (required) => {
    ...
    const conditionalClasses = required
                ...
                >
                    ...
                    <div className="dz-message flex flex-col items-center m-0!">
                        ...
                        <div className="mb-[22px] flex justify-center">
                            <div
                                className="flex h-[68px] w-[68px]  items-center justify-center rounded-full bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-400">
                                <svg
                        ...
                        <span
                            className=" text-center mb-5 block w-full max-w-[290px] text-sm text-gray-700 dark:text-gray-400">
              Drag and drop your ({description}) images here or browse
            </span>
