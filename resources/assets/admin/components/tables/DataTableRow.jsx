...
export default function DataTableRow({id, gridHeaderRow, row, setEditPath, handleDelete, location, dnd}) {
    ...
    const {attributes, listeners, setNodeRef, transform, transition} = dnd ? useSortable({
        id,
        attributes: {
            role: 'button',
            tabIndex: 0,
